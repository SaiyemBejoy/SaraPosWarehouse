        ...
        public async Task<List<DamageProductModel>> GetAllDamagelist()
        {
            var sql = "SELECT " +
                      "DAMAGE_TRANSFER_ID,"+
                        ...
                        "APPROVED_DATE,  " +
                        "APPROVED_YN  " +
                      "FROM DAMAGE_TRANSFER_MAIN WHERE  REQUISITION_NUM IS NULL AND TRANSFERED_BY IS NULL AND TRANSFER_DATE IS NULL AND REJECT_YN IS NULL AND D_REJECT_YN IS NULL ORDER BY D_APPROVED_YN  DESC, CREATED_DATE DESC";
        ...
        public async Task<List<DamageProductModel>> GetAllDamagelistForApproval()
        {
            var sql = "SELECT " +
                      "DAMAGE_TRANSFER_ID," +
                        ...
                        "CREATED_BY, " +
                        "CREATED_DATE  " +
                      "FROM DAMAGE_TRANSFER_MAIN WHERE  REQUISITION_NUM IS NULL AND TRANSFERED_BY IS NULL AND TRANSFER_DATE IS NULL AND APPROVED_YN IS NULL AND REJECT_YN IS NULL ORDER BY CREATED_DATE ";
        ...
        public async Task<List<DamageProductModel>> GetAllDamagelistForFinalApproval()
        {
            var sql = "SELECT " +
                      "DAMAGE_TRANSFER_ID," +
                        ...
                        "CREATED_BY, " +
                        "CREATED_DATE  " +
                      "FROM DAMAGE_TRANSFER_MAIN WHERE  REQUISITION_NUM IS NULL AND TRANSFERED_BY IS NULL AND TRANSFER_DATE IS NULL AND APPROVED_YN = 'Y' AND D_APPROVED_YN IS NULL AND REJECT_YN IS NULL AND D_REJECT_YN IS NULL ORDER BY CREATED_DATE ";
